...
public interface IMeetings
{
    ...
    Task<IResult> UpdateMeeting(Guid id, UpdateMeetingRequest request, 
    ...
    Task<IResult> GenerateListPdf(IPdfService pdfService, 
        CancellationToken cancellationToken);
    Task<IResult> GenerateMeetingPdf(Guid id, IPdfService pdfService,
        CancellationToken cancellationToken);
}